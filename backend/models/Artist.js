...
const artistSchema = new mongoose.Schema(
  {
    ...
    // ── NEW: tracks unread message count for Dashboard stats card ──
    unreadMessages: {
      type: Number,
      default: 0,
    },
    // ── NEW: persisted completion %, recomputed on every PUT /artist/profile ──
    profileCompletion: {
      type: Number,
      default: 0,
      min: 0,
...
artistSchema.methods.getPublicProfile = function () {
  return {
    ...
    profileCompletion: this.profileCompletion, // ── NEW
