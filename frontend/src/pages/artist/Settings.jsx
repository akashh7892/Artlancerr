        ...
        <div className="flex-1 w-full max-w-5xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
          ...
          <div className="flex gap-5 lg:gap-6">
            ...
            <div className="flex-1 min-w-0">
              {/* Mobile tab pills */}
              <div
                className="lg:hidden -mx-3 sm:-mx-6 px-3 sm:px-6 mb-4 overflow-x-auto"
                  ...
                  {TABS.map(({ id, label, icon: Icon }) => {
                    ...
                    return (
                      <button
                        key={id}
                        onClick={() => setActiveTab(id)}
                        className="flex items-center gap-2 px-3 py-2 rounded-full text-xs sm:text-sm font-medium transition-all flex-shrink-0"
                        style={{
                          background: isActive
                            ? `${COLORS.gold}20`
                            : COLORS.card,
