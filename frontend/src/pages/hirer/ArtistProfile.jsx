...
const FALLBACK_ARTIST = {
  ...
  coverPhoto:
    "https://images.unsplash.com/photo-1485846234645-a62644f84728?w=1200&fit=crop",
  skills: [
    "Cinematography",
    "Color Grading",
    "Lighting Design",
  ...
  available: true,
  bio: "Award-winning cinematographer specializing in narrative storytelling. With over 8 years of experience on independent and studio productions, I bring a distinctive visual style that elevates every project.",
  projects: 45,
  responseTime: "Within 2 hours",
  dailyRate: "$800",
  weeklyRate: "$4,500",
  projectRate: "Negotiable",
  topRated: true,
  bookedDates: [19, 20, 21, 26],
  equipment: [
    {
      id: 1,
      name: "Sony FX6",
      ...
      rental: "400",
      available: true,
      img: "https://images.unsplash.com/photo-1502920917128-1aa500764cbd?w=400&fit=crop",
    },
    {
      id: 2,
...
export default function ArtistProfile() {
  ...
  const rateValue = {
    ...
    "Weekly Rate": artist.weeklyRate || "$4,500",
